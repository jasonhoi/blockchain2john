#!/usr/bin/env python
#
# This python 3 script convert wallet file into supported crypto wallet HEX string
# wallet.aes.json (blockchain.info v1,v2,v3 wallet backup) / wallet.dat (Bitcoin Core wallet)
#
import sys
import os.path
import base64
